...
const TaskLink = ({ route, name, status }) => {
	...
	return <div className='task-link'>
...
const FormLinks = () => {
	...
	return <Fragment>
		...
		<TaskLink route='#' status={tellUsAboutYourselfStatus} name='Tell us more about you'/>
...
const Start = () => {
	const tasks = [
		...
		{
			title: '6. Assessment and training',
